...
async function seedDatabase() {
  try {
    ...
    // Создание основного курса (упрощенная версия для API)
...
5. Закрытие сделки (Closing)`,
            ...
            {
              title: 'Основы работы с объектами недвижимости',
              content: `Работа с объектами недвижимости требует глубокого понимания рынка. Типы объектов включают апартаменты, виллы, коммерческую недвижимость и земельные участки.`,
              order: 3,
            },
            {
              title: 'Коммуникация с клиентом',
              content: `Эффективная коммуникация - основа успешной работы риэлтора. Важно установить доверие с первых секунд разговора и активно слушать клиента.`,
              order: 4,
            },
            {
              title: 'Дисциплина, отчётность и работа в CRM',
              content: `Дисциплина и системность - залог успеха в работе риэлтора. Важно планировать день, регулярно работать с клиентами и вести отчётность.`,
              order: 5,
            },
          ],
        },
